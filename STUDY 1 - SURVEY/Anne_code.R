...
#. Load data set ----
mydata <- read.csv("Anne data.csv", sep = ";", na = c('NA','-77', '-99', '-66')) #change name
view(mydata)  
...
write.csv(mydata, "Filtered_data.csv", row.names = TRUE) #export the new clean data set :)
...
#. OPTIONAL: recode character into numeric variables ----
...
#***********************************************************************
#06 Description of the data set: Descriptive information and frequencies ----
...
#***********************************************************************
#07 Description of the data set: Correlations ----
...
sjPlot::tab_corr(mydata.scale[, c("JODfr", "JOP", "JSInpr", "JSInfr", "JO", "TRUSTs","TRUSTo", "SAT","EXH","COM" )], na.deletion = "listwise", corr.method = "pearson", 
                 title = "Hypothesis expl.", show.p = TRUE, digits = 2, triangle = "lower", file = "TRUSTs_TRUSTo_correlations.mydata.scale.htm") #correlation matrix
                 #If you want the actual p-values instead of asterisks, include ‘p.numeric = TRUE’ as an argument in the sjPlot::tab_corr command.

#***********************************************************************
#09 Hypotheses testing: OLS regression ----
...
#***********************************************************************
#11 TO DO: OLS regression tables ----
